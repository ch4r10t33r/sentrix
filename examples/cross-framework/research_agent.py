"""
ResearchAgent — Google ADK, wrapped for the Inai mesh.
──────────────────────────────────────────────────────────
...
def build_research_agent():
    """
    Build and return a Inai-wrapped ResearchAgent.
    ...
    if DEMO_MODE or not _ADK_AVAILABLE:
        ...
        # Shows full Inai plumbing (capability extraction, discovery, A2A calling)
