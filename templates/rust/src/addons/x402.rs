...
//!
//! This module implements the [x402 payment protocol](https://x402.org) for Inai agents.
...
//! use inai::addons::x402::{X402Server, usdc_base};
...
//!
//! ```rust,no_run
//! use inai::addons::x402::{X402Client, X402PaymentRequirements};
//!
...
//!
//! The Inai `AgentRequest` type (in `request.rs`) does not ship with an
...
//!
//! ```rust,no_run
//! use inai::addons::x402::X402Payment;
//! use inai::request::AgentRequest;
...
/// # Example
/// ```rust,no_run
/// use inai::addons::x402::usdc_base;
...
/// // Pass `server` to `inai::server::serve(server, 6174)`.
/// ```
