//! Agno → Inai Plugin (Rust) — HTTP Bridge
//!
//! Wraps a deployed Agno FastAPI server so it participates in the Inai mesh
...
//! ── Usage ─────────────────────────────────────────────────────────────────────
//!
//!   use inai::plugins::agno::{AgnoPlugin, AgnoService};
...
//!       agent_id:     "inai://agent/agno-researcher".to_string(),
...
#[async_trait]
impl InaiPlugin<AgnoService> for AgnoPlugin {
