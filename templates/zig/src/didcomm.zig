...
pub const MSG_INVOKE   = "https://inai.dev/didcomm/1.0/invoke";
pub const MSG_RESPONSE = "https://inai.dev/didcomm/1.0/response";
pub const MSG_FORWARD  = "https://inai.dev/didcomm/1.0/forward";
pub const MSG_PING     = "https://inai.dev/didcomm/1.0/ping";
pub const MSG_PONG     = "https://inai.dev/didcomm/1.0/pong";
