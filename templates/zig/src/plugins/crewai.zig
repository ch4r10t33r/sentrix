//! CrewAI → Inai Plugin (Zig) — HTTP Bridge
//!
//! Wraps a running CrewAI HTTP service so Zig agents on the Inai mesh can
...
//!       .agent_id = "inai://agent/writer-crew",
//!       .owner    = "0xYourWallet",
//!   }, allocator);
...
pub const CrewAIPlugin = struct {
    ...
    /// Build the CrewAI kickoff JSON body from a Inai `AgentRequest`.
    ///
