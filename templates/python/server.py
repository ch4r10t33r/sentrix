...
Inai HTTP Server
──────────────────────────────────────────────────────────────────────────────
Starts an HTTP server for a WrappedAgent, exposing the standard Inai
...
async def serve(
    ...
    """
    port = int(os.environ.get("INAI_PORT", port))
    ...
    try:
        ...
        try:
            ...
            raise RuntimeError(
                "\n[Inai] No async HTTP backend found.\n"
                "Install one of:\n"
                "  pip install aiohttp\n"
