"""
LlamaIndexPlugin — Inai adapter for LlamaIndex agents.

Wraps a LlamaIndex agent (ReActAgent, OpenAIAgent, FunctionCallingAgent, etc.)
so it is fully discoverable and callable on the Inai mesh.
...
class LlamaIndexPlugin(InaiPlugin):
    """
    Inai ↔ LlamaIndex bridge.
...
def wrap_llamaindex(
    ...
    **kwargs:      Any,
    ...
    """
    Wrap a LlamaIndex agent for the Inai mesh.

    Args:
        agent:         The LlamaIndex agent instance.
        name:          Human-readable display name.
        agent_id:      Unique Inai URI.
