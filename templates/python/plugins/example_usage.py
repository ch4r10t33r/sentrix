...
──────────────────────────────────────────────────────────────────────────────
Shows how to wrap LangGraph and Google ADK agents for Inai in <10 lines.
...
# ─────────────────────────────────────────────────────────────────────────────
# Example 1: LangGraph ReAct agent → Inai
# ─────────────────────────────────────────────────────────────────────────────

async def example_langgraph():
    """
    Wraps a standard LangGraph ReAct agent with two tools.
    Each tool becomes a separate Inai capability.
    """
    try:
    ...
    # ── wrap for Inai (one function call) ───────────────────────────────────
    ...
    # ── register on the Inai mesh ───────────────────────────────────────────
    await agent.register_discovery()

    # ── handle a Inai request ───────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# Example 2: Google ADK agent → Inai
# ─────────────────────────────────────────────────────────────────────────────
...
async def example_multi_framework():
    """
    A LangGraph agent and a Google ADK agent coexist on the same Inai mesh.
    Agents can discover and call each other using standard Inai requests,
    ...
    for agent_id, name, caps in [
        ("inai://agent/weather", "WeatherAgent", ["get_weather", "get_forecast"]),
        ("inai://agent/support", "SupportAgent", ["search_docs", "create_ticket"]),
    ]:
    ...
    # Any Inai agent can now discover the others
