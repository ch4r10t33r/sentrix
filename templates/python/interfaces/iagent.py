...
Every Inai agent must implement this abstract base class.
...
class IAgent(ABC):
    # ── Identity ───────────────────────────────────────────────────────────
    agent_id: str                            # e.g. "inai://agent/0xABC..."
    ...
    async def sign_message(self, message: str) -> str:
        ...
        Uses (in priority order):
          ...
          2. INAI_AGENT_KEY env var    (hex private key)
        ...
        # 2. Fall back to INAI_AGENT_KEY env var
        raw_key = os.environ.get('INAI_AGENT_KEY', '')
        if raw_key:
        ...
        raise RuntimeError(
            ...
            "or set INAI_AGENT_KEY=<hex-private-key> env var."
        )
