"""
IAgentClient — standard interface for discovering and calling other Inai agents.
"""
...
class IAgentClient(ABC):
    """
    Standard interface for discovering and calling Inai agents.
    ...
    async def call(
        ...
        *,
        ...
        Args:
            agent_id:    The target agent's Inai ID (e.g. inai://agent/0xABC…)
    ...
    def stream(
        ...
        *,
        ...
        Args:
            agent_id:   The target agent's Inai ID.
